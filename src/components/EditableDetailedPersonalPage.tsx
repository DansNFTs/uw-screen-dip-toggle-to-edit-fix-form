...
export const EditableDetailedPersonalPage: React.FC<EditableDetailedPersonalPageProps> = ({
  ...
  const [formData, setFormData] = useState<PersonalData>({
    ...
    birthYear: applicantNumber === 1 ? '1965' : '1968',
    ...
    grossBasicIncome: applicantNumber === 1 ? '£100000.00' : '£45000.00',
    frequency: 'Yearly',
    annualAmount: applicantNumber === 1 ? '£50,000.00' : '£30,000.00',
    monthlyNetSalary: applicantNumber === 1 ? '£5200' : '£3100',
    jobTitle: applicantNumber === 1 ? 'Accountant' : 'Manager',
